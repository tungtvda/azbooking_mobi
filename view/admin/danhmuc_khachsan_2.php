...
function view_danhmuc_khachsan_2($data)
{
    ...
    $ft->assign('TABLE-NAME','danhmuc_khachsan_2');
...
{
    return '<th>id</th><th>danhmuc_id</th><th>name</th><th>img</th><th>img_banner</th><th>position</th>';
}
//
function showTableBody($data)
{
    ...
    if(count($data)>0) foreach($data as $obj)
    {
        ...
        $TableBody.="<td><img src=\"".$obj->img_banner."\" width=\"50px\" height=\"50px\"/> </td>";
...
function showFrom($form,$ListKey=array())
{
    ...
    $str_from.='<p><label>img_banner</label><input class="text-input small-input" type="text"  name="img_banner" value="'.(($form!=false)?$form->img_banner:'').'"/><a class="button" onclick="openKcEditor(\'img_banner\');">Upload ảnh</a></p>';
