        ...
        $asign['content_user'].='<div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="'.SITE_NAME_MAIN.'/tiep-thi-lien-ket/"><i class="fa fa-share-alt "></i> Tiếp thị liên
                            kết</a>
                            <a target="_blank" href="'.SITE_NAME_MAIN.'/tiep-thi-lien-ket/thanh-vien/?type=dang-ky&key_id='._return_mc_encrypt($data_session['id']).'"><i class="fa fa-link "></i> Link đăng ký </a>
