...
if (isset($_POST['name_customer'])) {
    ...
    $email_customer_sub = '';
    $phone_customer_sub = '';
    $address_customer_sub = '';
    $tuoi_customer_sub = '';
    $tuoi_number_customer_sub = '';
    $birthday_customer_sub = '';
    ...
    if ($name_customer != '' && $email != '' && $phone != '' && $num_nguoi_lon != ''  && $ngay_khoi_hanh != '' && $insert == true) {
...
//        curl_setopt($ch, CURLOPT_URL,"http://localhost/manage_mix/booking-website/");
        ...
        if ($res === 0) {
            ...
            if (count($data_detail_booking) > 0) {
                ...
                $logo = SITE_NAME_MAIN . '/email_template/images/logoazboong.vn.png';
                $banner = SITE_NAME_MAIN . '/email_template/images/banner.jpg';
                $footer = SITE_NAME_MAIN . '/email_template/images/footer.png';
